...
<div class="d-flex">
    <nav class=" sidebar pt-3 ms-5">
        <ul class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="v-pills-customers-tab" data-bs-toggle="pill" href="#v-pills-customers"
    ...
    <div class="container-fluid mt-4">
        <div class="home mt-4 ms-5">
            <div class="" style="width: 1100px">
                <form action="/admin/addKH" method="post">
                    <div class="mb-3">
                        <label for="tenKhachHang" class="form-label">Tên khách hàng</label>
                        <input type="text" class="form-control" name="ho_ten" id="tenKhachHang" placeholder="Nhập họ tên khách hàng">
                    </div>
                    <div class="mb-3">
                        <label for="diaChi" class="form-label">Địa chỉ</label>
                        <input type="text" class="form-control" name="dia_chi" id="diaChi" placeholder="Nhập địa chỉ">
                    </div>
                    <div class="mb-3">
