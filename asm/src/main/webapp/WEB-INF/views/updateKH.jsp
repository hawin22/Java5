    ...
    <div class="container-fluid mt-4">
        <div class="home mt-4 ms-5">
            <div class="" style="width: 1100px">
                <form action="/admin/updateKH/${detailKH.id}" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="${detailKH.dia_chi}"
                               name="dia_chi" id="diaChi" placeholder="Nhập địa chỉ">
                    </div>
                    <div class="mb-3">
                        <label for="sdt" class="form-label">Số điện thoai</label>
                        <input type="text" class="form-control" value="${detailKH.sdt}"
                               name="sdt" id="sdt" placeholder="Nhập số điện thoại">
                    </div>
                    <div class=" mb-3">
